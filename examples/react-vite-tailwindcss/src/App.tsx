      ...
      <div className="max-w-7xl mx-auto">
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-900 dark:text-gray-100 mb-2">
            rud-dashboard React + Tailwind Example
          </h1>
          <p className="text-gray-600 dark:text-gray-400">
            Testing the package with React + Tailwind CSS - Try edit mode to see custom menu icons!
          </p>
        </div>
        ...
        <div className="mt-8 p-6 bg-green-50 border border-green-200 rounded-lg dark:bg-green-900/20 dark:border-green-800">
          <div className="flex items-start gap-3">
            ...
            <div>
              <h3 className="font-semibold text-green-900 dark:text-green-300">Tailwind Setup Working!</h3>
              <p className="text-sm text-green-700 dark:text-green-400 mt-1">
                The rud-dashboard package is working with React + Tailwind.
